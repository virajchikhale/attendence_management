		        ...
		        <form class="form-register" action="#" method="post">
		        	<div id="form-total">
			            ...
			            <h2>
			            	...
			            	<span class="step-text">HOD's Infomation</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<div class="wizard-header">
									<h3 class="heading">Peronal Infomation of HOD</h3>
			            ...
			            <section>
			                <div class="inner">
			                	<div class="wizard-header">
									<h3 class="heading">Department Selection</h3>
									<p>Please select the department and whom you going to report.</p>
								</div>
								<div class="form-row">
